...
function About() {
  return (
    ...
    id="about"
    >
        <div className="w-[100%] h-[600px] bg-white flex flex-col gap-10 py-10 text-center relative">
            <Image src='/gradient-landscape.jpg' alt='landscape image' width={600} height={500} className="w-[70%] h-[100%] mx-auto object-cover" />
